...
import programacion.educacion.Asignatura;

public class MainExamen2aEvaluacion {
  /*
   * Creamos un máximo número de estudiantes soportados por la aplicación:
   * MAX_ESTUDIANTES
   * No deberíamos soportar una asignatura con más de 100 estudiantes: posibles
   * problemas de
   * memoria. ¿Qué ocurre si un usuario introduce como número máximo de
   * estudiantes 10 mil millones?
   * Un objeto Estudiante contiene 3 referencias a String y cada una ocupa 4
   * bytes.
   */
